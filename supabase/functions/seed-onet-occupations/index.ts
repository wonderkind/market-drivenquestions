...
// All 867 O*NET-SOC Detailed Occupations
const ONET_OCCUPATIONS = `11-1011	Chief Executives
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    console.log('Parsing O*NET occupations...');
    
    const lines = ONET_OCCUPATIONS.split('\n');
